...
import { ShieldCheck, ArrowRight, Eye, EyeOff, Globe } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <input
            ...
            placeholder={ar ? "example@company.com" : "example@company.com"}
            required
            className="w-full mb-4 px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm"
            dir="ltr"
          />
          ...
          <div className="relative mb-4">
            <input
              ...
              placeholder="••••••••"
              required
              className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 pr-11 text-sm"
              dir="ltr"
            />
            <button
              type="button"
